...
function CodexGlyph({ className }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <path clipRule="evenodd" d={CODEX_ICON_PATH} />
    </svg>
  );
}
...
export function CliBrandIcon({ workerType, className }: CliBrandIconProps) {
  switch (workerType) {
    case "codex":
      return <CodexGlyph className={className} />;
    case "claude":
      return <SimpleIconsGlyph path={CLAUDE_ICON_PATH} className={className} />;
    case "gemini":
      return <SimpleIconsGlyph path={GEMINI_ICON_PATH} className={className} />;
    case "opencode":
